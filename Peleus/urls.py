...
urlpatterns = patterns(
    ...
    url(r'^forecast/(?P<id>\d+)/analysis$', views.CommunityAnalysisView.as_view(), name='community_analysis_see_full_set'),
    ...
    url(r'^confirm_email/(?P<token>\w+)$', views.SignUpSecondView.as_view()),
